...
@media(max-width:600px){.row2,.row3{grid-template-columns:1fr}.toolbar{flex-direction:column;align-items:stretch}.search{min-width:100%}.filter-sel{width:100%}.trial-bar{flex-direction:column;align-items:stretch}.trial-bar input.key-input{width:100%}}
...
You can view your existing inventory, but adding, editing, or deleting items is locked until you start a 14-day free trial.
</div>
