...
// newTestDB is a local helper since quartermaster has no existing test
// file that defines one.
func newTestDB(t *testing.T) *store.DB {
	t.Helper()
	dir, err := os.MkdirTemp("", "quartermaster-trial-test-*")
	if err != nil {
